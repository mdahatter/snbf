...
public class EditMessageAction extends PortletAction {
	...
	public void processAction(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (e instanceof NoSuchMessageException
				...
				setForward(actionRequest, "portlet.ideas.error");
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		return mapping.findForward("portlet.ideas.edit_message");
	}
	...
	protected String getRedirect(ActionRequest actionRequest,
		...
		int workflowAction = ParamUtil.getInteger(actionRequest,
				"workflowAction", WorkflowConstants.ACTION_PUBLISH);

		if (workflowAction == WorkflowConstants.ACTION_SAVE_DRAFT) {
			return getSaveAndContinueRedirect(actionRequest, actionResponse,
					message);
	...
	protected String getSaveAndContinueRedirect(ActionRequest actionRequest,
		...
		PortletURL portletURL = ((ActionResponseImpl) actionResponse)
				.createRenderURL();

		portletURL
				.setParameter("struts_action", "/ideas/edit_message");
	...
	protected MBMessage updateMessage(ActionRequest actionRequest,
		...
		try {
			...
			boolean subscribe = ParamUtil
					.getBoolean(actionRequest, "subscribe");
